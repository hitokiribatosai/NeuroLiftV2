...
export const translations = {
  en: {
    ...
    profile_units: "Units",
    profile_accent: "Accent Color",
    accent_default: "Default (Royal/Teal)",
    accent_pink: "Pink",
    accent_red: "Red",
  ...
  fr: {
    ...
    profile_accent: "Couleur d'accentuation",
    accent_default: "Défaut (Bleu/Sarcelle)",
    accent_pink: "Rose",
    accent_red: "Rouge",
    accent_yellow: "Jaune",
  ...
  ar: {
    ...
    profile_accent: "لون التمييز",
    accent_default: "الافتراضي (أزرق/أخضر مائل للأزرق)",
    accent_pink: "وردي",
    accent_red: "أحمر",
    accent_yellow: "أصفر",
