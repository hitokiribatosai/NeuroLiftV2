    ...
    <AnimatePresence>
      {isSettingsOpen && (
        <motion.div
          ...
          className={`absolute top-full mt-2 w-64 max-h-[80vh] overflow-y-auto bg-zinc-950/95 backdrop-blur-xl border border-zinc-800 rounded-3xl p-4 shadow-2xl z-[100] ${dir === 'rtl' ? 'left-0' : 'right-0'}`}
        >
          <div className="mb-6">
          ...
          <div className="mt-6 pt-6 border-t border-zinc-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              {([
                { id: 'default' as AccentColor, label: t('accent_default') as string || 'Default', dark: '#14b8a6', light: '#4263eb' },
                { id: 'pink' as AccentColor, label: t('accent_pink') as string || 'Pink', dark: '#ec4899', light: '#ec4899' },
                { id: 'red' as AccentColor, label: t('accent_red') as string || 'Red', dark: '#ef4444', light: '#ef4444' },
                { id: 'yellow' as AccentColor, label: t('accent_yellow') as string || 'Yellow', dark: '#f59e0b', light: '#f59e0b' },
              ]).map((acc) => (
                <motion.button
                  key={acc.id}
                ...
                >
                  <div className="w-4 h-4 rounded-full shadow-inner" style={{ backgroundColor: theme === 'light' ? acc.light : acc.dark }} />
